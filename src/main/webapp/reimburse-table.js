...
window.onload = function(){
    ...
    fetch(`http://${hostname}/project01-team01/reimbursements`) // TODO NAME FOR THIS EDIT THIS LINE FOR 
...
function buildTable(data){
    ...
    data.forEach(element => {
        ...
        td5.innerHTML = element.dateSubmitted;
